...
function SummerHtmlImageMapCreator() {
	...
	var app = (function() {
      ...
      //  window.addEventListener('click', recalcOffsetValues, false);
		/* Disable selection */
	...
	var buttons = (function() {
		...
		function onSaveMap(e) {	
			 $.post("index.php?r=Product/ProductAttributeMapValue/update", {Value:  app.getHTMLCode(),ProductAttributeID:ProductAttributeID ,ProductValueID:ProductValueID}, function(result){
        alert(result);
    });
			app.deselectAll()
				   .setMode('preview')
		...
		savemap.addEventListener('click', onSaveMap, false);
	...
	Rect.prototype.setCoords = function(params){
		...
		this.helpers.center.setCoords(params.x , params.y );
		this.helpers.top.setCoords(params.x , params.y);
		this.helpers.bottom.setCoords(params.x , params.y + params.height);
		this.helpers.left.setCoords(params.x, params.y );
		this.helpers.right.setCoords(params.x + params.width, params.y );
...
//document.addEventListener("ready", SummerHtmlImageMapCreator, false);