            ...
            if (mode === 'editing') {
                if (e.target.parentNode.tagName === 'g') {
                  ...
                  //  var target = e.target || e.srcElement;
                    selected_area = e.target.parentNode;
if(selected_area.obj!= null) {
    selected_area = selected_area.obj;
}else {
    selected_area = e.target.node;
}
        ...
        return {
            saveInLocalStorage : function() {
                ...
                $.post("index.php?r=Product/ProductAttributeMapValue/update", {ValueJson:  JSON.stringify(obj),ValueSVG:  app.getSVGCode(),ValueMap:  app.getHTMLCode(),ProductAttributeID:ProductAttributeID ,ProductValueID:ProductValueID}, function(result){
                    // alert(result);
                });
            ...
            loadFromLocalStorage : function() {
                ...
                var str = JSON.stringify(window.localStorage.getItem('SummerHTMLImageMapCreator')),
                    obj = JSON.parse(str),
                    obj = JSON.parse(obj),
                    areas = obj.areas;
