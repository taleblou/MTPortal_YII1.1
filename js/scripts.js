...
function SummerHtmlImageMapCreator() {
	...
	var buttons = (function() {
		...
		function onSaveButtonClick(e) {
            ...
            $.post("index.php?r=Product/ProductAttributeMapValue/update", {ValueSVG:  app.getSVGCode(),ValueMap:  app.getHTMLCode(),ProductAttributeID:ProductAttributeID ,ProductValueID:ProductValueID}, function(result){
                // alert(result);
            });
			app.saveInLocalStorage();
